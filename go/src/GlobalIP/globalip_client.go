...
// NewClient creates and returns a new HTTP client object for the GlobalIP service
func NewClient(url string, transport http.RoundTripper) GlobalIPClient {
	return GlobalIPClient{url, transport, nil, nil, 0}
}

// AddCredentials adds the credentials to the client for subsequent requests.
func (client *GlobalIPClient) AddCredentials(header string, token string) {
	client.CredsHeader = &header
	client.CredsToken = &token
}

func (client GlobalIPClient) getClient() *http.Client {
	var c *http.Client
...
func (client GlobalIPClient) addAuthHeader(req *http.Request) {
...
func (client GlobalIPClient) httpGet(url string, headers map[string]string) (*http.Response, error) {
...
func (client GlobalIPClient) httpDelete(url string, headers map[string]string) (*http.Response, error) {
	hclient := client.getClient()
...
func (client GlobalIPClient) httpPut(url string, headers map[string]string, body []byte) (*http.Response, error) {
...
func (client GlobalIPClient) httpPost(url string, headers map[string]string, body []byte) (*http.Response, error) {
	var contentReader io.Reader
	if body != nil {
		contentReader = bytes.NewReader(body)
	}
...
func (client GlobalIPClient) httpPatch(url string, headers map[string]string, body []byte) (*http.Response, error) {
	var contentReader io.Reader
	if body != nil {
		contentReader = bytes.NewReader(body)
	}
...
func (client GlobalIPClient) httpOptions(url string, headers map[string]string, body []byte) (*http.Response, error) {
...
func (client GlobalIPClient) GetResponse() (*Response, error) {
	var data *Response
	url := client.URL + "/ip"
